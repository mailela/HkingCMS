$(function () {
    ...
    $('#chart_map').click(function(){
        window.location.href = tpl+"/page/index.html";
    });
    $('.t_btn2').click(function(){
        window.location.href = tpl+"/page/index.html?id=2";
    });
    $('.t_btn3').click(function(){
        window.location.href = tpl+"/page/index.html?id=3";
    });
    $('.t_btn4').click(function(){
        window.location.href = tpl+"/page/index.html?id=4";
    });
    $('.t_btn5').click(function(){
        window.location.href = tpl+"/page/index.html?id=5";
    });
    $('.t_btn6').click(function(){
        window.location.href = tpl+"/page/index.html?id=6";
    });
    $('.t_btn7').click(function(){
        window.location.href = tpl+"/page/index.html?id=7";
    });
    $('.t_btn8').click(function(){
        window.location.href = tpl+"/page/index.html?id=8";
    });
    $('.t_btn9').click(function(){
        window.location.href = tpl+"/page/index.html?id=9";
    });
});
