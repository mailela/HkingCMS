...
<head>
    ...
    <?php }?>
    <title>HkingCMS提示信息</title>
    <link rel="Shortcut Icon" href="<?php echo STATIC_URL;?>admin/hg_admin/images/favicon.ico"/>
    <style type="text/css">
        *{padding:0;margin:0;}
        ...
        #msgtit{height:35px;line-height:35px;color:#fff;background:#09c;border-radius: 16px;}
        #msgbody{margin:20px 0;text-align:center} #info{margin-bottom:10px;}
        #msgbody p{font-size:14px;}
        #msgbody p a{font-size:14px;color:#333;text-decoration:none;}
        #msgbody p a:hover {color:#09c;}
    </style>
</head>
<body>
<div id="msg" class="ss">
