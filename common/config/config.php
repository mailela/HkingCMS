...
return array(
    ...
    'db_name' => 'www_hkingcms_com',		// 数据库名
    'db_user' => 'www_hkingcms_com',       // 用户名
    'db_pwd' => 'iJBsDJ5seD2JadLr',       		// 密码
    'db_port' => 3306,         // 端口
    ...
    'cookie_pre'         => 'hkingphp_',    //Cookie 前缀，同一域名下安装多套系统时，请修改Cookie前缀
    ...
    //缓存类型为file缓存时的配置项
    'file_config'        => array (
		'cache_dir'      => HKINGPHP_PATH.'cache/chche_file/',    //缓存文件目录
