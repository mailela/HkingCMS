...
define('HKINGPHP_PATH', $document_root.$web_path);

include HKINGPHP_PATH.'hkingphp'.DIRECTORY_SEPARATOR.'core'.DIRECTORY_SEPARATOR.'class'.DIRECTORY_SEPARATOR.'image.class.php';
