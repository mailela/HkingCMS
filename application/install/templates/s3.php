<?php defined('IN_HkingCMS') or exit('No Define HkingCMS.'); ?>
<!doctype html>
<html>
    <head>
        <meta charset="UTF-8" />
                    ...
                    <div class="server">
                        <table width="100%">
                            ...
                            <tr>
                                ...
                                <td><input type="text" name="dbname" id="dbname" value="hkingcms" class="input"></td>
                                <td><div id="J_install_tip_dbname"></div></td>
                            </tr>
                            <tr>
                                <td class="tar">数据库表前缀：</td>
                                <td><input type="text" name="dbprefix" id="dbprefix" value="hg_" class="input"></td>
                        ...
                        <table width="100%">
                            ...
                            <tr>
                                ...
                                <td><input type="text" name="sitename" value="HkingCMS - 演示站" class="input"></td>
...
<!--                            <tr>
                        ...
                        <table width="100%">
                            ...
                            <tr>
                                ...
                                <td><input type="text" name="manager_adminname" class="input" value="hkingcms"></td>
                                <td><div id="J_install_tip_manager_adminname"></div></td>
                            </tr>
                            <tr>
                                <td class="tar">密码：</td>
                                <td><input type="text" name="manager_pwd" id="J_manager_pwd" class="input" value="hkingcms" autoComplete="off"></td>
                                <td><div id="J_install_tip_manager_pwd"></div></td>
                            </tr>
                            <tr>
                                <td class="tar">重复密码：</td>
                                <td><input type="text" name="manager_ckpwd" class="input" value="hkingcms" autoComplete="off"></td>
