...
class menu extends common {
	...
	public function init() {
		...
		$array = array();
		foreach($data as $v) {
			$v['string'] = '<a title="增加子类" href="javascript:;" onclick="hg_open(\'增加菜单\',\''.U('add',array('parentid'=>$v['id'])).'\',800,500)" style="text-decoration:none"  class="btn-mini btn-success ml-5">增加子类</a> <a title="编辑菜单" href="javascript:;" onclick="hg_open(\'编辑菜单\',\''.U('edit',array('id'=>$v['id'])).'\',800,500)" style="text-decoration:none"  class="btn-mini btn-secondary ml-5">编辑</a> <a title="删除" href="javascript:;" onclick="hg_del(\''.U('delete',array('id'=>$v['id'])).'\')" style="text-decoration:none"  class="btn-mini btn-warning ml-5">删除</a>';
