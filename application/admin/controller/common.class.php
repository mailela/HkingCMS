...
class common{
	 ...
	 * @return bool|string
	 */
	final public static function control_path($file, $m = '') {
		$m = empty($m) ? ROUTE_M : $m;
		if(empty($m)) return false;
		return APP_PATH.$m.DIRECTORY_SEPARATOR.'view'.DIRECTORY_SEPARATOR.'controls'.DIRECTORY_SEPARATOR.$file.'.ctl.php';
	}
}
?>