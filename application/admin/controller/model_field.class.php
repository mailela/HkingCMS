...
class model_field extends common {
	...
	public function init() {
		...
		$data = $model_field->where(array('modelid' => 0),array('modelid' => $this->modelid))->order('modelid asc,listorder ASC,field ASC')->select();
...
//			include $this->admin_tpl('model_field_add');
			include $this->admin_tpl('model_field_template');
		}
	}
