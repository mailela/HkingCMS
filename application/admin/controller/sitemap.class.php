...
class sitemap extends common {
	...
	public function init() {
		...
		if(is_file(HKINGPHP_PATH.'sitemap.xml')){
			$is_make_xml = true;
			$make_xml_time = date('Y-m-d H:i:s', filectime(HKINGPHP_PATH.'sitemap.xml'));
		}
		if(is_file(HKINGPHP_PATH.'sitemap.txt')){
			$is_make_txt = true;
			$make_txt_time = date('Y-m-d H:i:s', filectime(HKINGPHP_PATH.'sitemap.txt'));
		}
	...
	public function make_sitemap() {
		if(isset($_POST['dosubmit'])){
			...
			$strlen = @file_put_contents(HKINGPHP_PATH.$this->filename, $str);
